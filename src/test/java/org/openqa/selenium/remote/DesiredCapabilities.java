...
public class DesiredCapabilities implements Serializable, Capabilities {
  ...
  public static DesiredCapabilities appium() {
  
	  			 File appDir = new File("C://Tanja");
	  			 //File app = new File(appDir, "IPMessenger-1.0.84-111.apk"); 
	  			 File app1 = new File(appDir, "resigned-IPMessenger_ATT_20150731_7397_unsigned.apk");
		  		//File app=new File("C:\\Users\\g800688\\Desktop\\APK\\resigned-IPMessenger_ATT_20150731_7397_unsigned.apk");
	  			DesiredCapabilities capabilities = new DesiredCapabilities(); 
	  			...
	  			capabilities.setCapability("appPackage", "com.att.businessmessaging"); 
	  			capabilities.setCapability("appActivity", "com.syniverse.ipmessenger.ui.MainActivity"); 
	  			capabilities.setCapability("app", app1.getAbsolutePath());
	  			//capabilities.setCapability(app, app);
	  			capabilities.setCapability("deviceName", "GalaxyS3NexusOne");
	  			capabilities.setCapability("deviceID", "940e6245");
